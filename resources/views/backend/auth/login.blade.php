    ...
    {!! Form::open(['route' => 'backend.login', 'method' => 'POST']) !!}
        <div class="row">
            <div class="form-group col-md-12 mb-4">
                {!! Form::email('email', '', ['class' => 'form-control input-lg', 'id' => 'email', 'aria-describedby' => 'emailHelp', 'placeholder' => '']) !!}
            </div>

            <div class="form-group col-md-12 ">
                {!! Form::password('password', ['class' => 'form-control input-lg', 'id' => 'password', 'placeholder' => '']) !!}
            </div>
            ...
            <div class="col-md-12">
                <div class="d-flex my-2 justify-content-between">
                    <div class="d-inline-block mr-3">
                        <label class="control control-checkbox">{{getAction('remember_me')}}
                            {!! Form::checkbox('remember', '1', true|false|null) !!}
                ...
                <p>
                    {{getMessage('not_have_account')}}
                    <a class="text-blue" href="#">{{getAction('sign_up')}}</a>
                </p>
            </div>
        </div>
    {!! Form::close() !!}
